(function () {
  ...
  var ORIGINAL_FORM_ROUTES = Object.freeze({
    VF1: Object.freeze({
      form: "https://docs.google.com/forms/d/e/1FAIpQLScOOy3NTX1aIuHk_tfVG-LGsOHFsyJdU0PLGlSFizR2CFWK0g/viewform",
      entry: "1040067335",
    }),
    VF2: Object.freeze({
      form: "https://docs.google.com/forms/d/e/1FAIpQLSfwQ-rVxYwumoYBkndLUsrakiFPv9LGm47d7pjRfAuoFZ9Rgg/viewform",
      entry: "1040067335",
    }),
    RI1: Object.freeze({
      form: "https://docs.google.com/forms/d/e/1FAIpQLScxFRLu_UYUFqD9iborLAr5n5EXi_tI9Hjb-8DdUN4QFL6FxQ/viewform",
      entry: "1040067335",
    }),
    RI2: Object.freeze({
      form: "https://docs.google.com/forms/d/e/1FAIpQLSfq_3Cv80fXEojG0TvwsxHReh3zUieo8lr5SoEBTkb3qL2Vhw/viewform",
      entry: "1040067335",
    }),
    RI1_CORRECTION: Object.freeze({
      form: "https://docs.google.com/forms/d/e/1FAIpQLSd1hBw9Xm6kbx_ryIb3ivAsMKm-9I4ki_Qa60VXemmP-fh8kg/viewform",
      entry: "1040067335",
    }),
    RI2_CORRECTION: Object.freeze({
      form: "https://docs.google.com/forms/d/e/1FAIpQLSfyuDFyxDjaBrLlwfqwwfCLB25tDDka2ZfyV48DaYapY8oaog/viewform",
      entry: "1040067335",
    }),
    GRAMMAR: Object.freeze({
      form: "https://docs.google.com/forms/d/e/1FAIpQLSfz3w5t6VffWL-OqNrrZJPE-DrR3L7RFt3u8Z-QsU9t6HW93g/viewform",
      entry: "1104752903",
    }),
    ACADEMIC: Object.freeze({
      form: "https://docs.google.com/forms/d/e/1FAIpQLSeE7deH99J04Rq9LWAPS6moFYONABFpxfwq86vZ7G4_kkwe0Q/viewform",
      entry: "982583688",
    }),
  });

  function originalFormForCode(code) {
    var route = null;
    if (/^VF1-U(?:0[1-9]|1[0-4])$/.test(code)) route = ORIGINAL_FORM_ROUTES.VF1;
    else if (/^VF2-U(?:0[1-9]|1[0-4])$/.test(code)) route = ORIGINAL_FORM_ROUTES.VF2;
    else if (/^RI1-U(?:0[1-9]|1[0-2])$/.test(code)) route = ORIGINAL_FORM_ROUTES.RI1;
    else if (/^RI2-U(?:0[1-9]|1[0-2])$/.test(code)) route = ORIGINAL_FORM_ROUTES.RI2;
    else if (/^RI1-C(?:0[1-9]|1[0-2])$/.test(code)) route = ORIGINAL_FORM_ROUTES.RI1_CORRECTION;
    else if (/^RI2-C(?:0[1-9]|1[0-2])$/.test(code)) route = ORIGINAL_FORM_ROUTES.RI2_CORRECTION;
    else if (/^GF1-U(?:0[1-9]|1[0-9]|20|04\.[12]|05\.[12]|09\.[12])-LT$/.test(code)) route = ORIGINAL_FORM_ROUTES.GRAMMAR;
    else if (/^AP-B0[1-8]$/.test(code)) route = ORIGINAL_FORM_ROUTES.ACADEMIC;
    if (!route) return "";
  ...
  var originalFormDestination = originalFormForCode(requestedCode);
  if (originalFormDestination) {
    window.location.replace(originalFormDestination);
    return;
  }

(function () {
  ...
  var IELTS_WRITING_ASSIGNMENTS = Object.freeze({
    ...
    "IELTS-WRITING-W17": Object.freeze({
      lesson: 17,
      tasks: Object.freeze([
        Object.freeze({ type: "source", title: "US TRAVEL REASONS AND ISSUES", prompt: "The charts below show reasons for travel and the main issues for the travelling public in the US in 2009. Summarise the information by selecting and reporting the main features, and make comparisons where relevant.", minWords: 150 }),
        Object.freeze({ type: "source", title: "AUSTRALIAN TEMPERATURES AND RAINFALL", prompt: "The charts compare temperatures and rainfall in two major Australian cities. Summarise the information by selecting and reporting the main features, and make comparisons where relevant.", minWords: 150 }),
      ]),
    }),

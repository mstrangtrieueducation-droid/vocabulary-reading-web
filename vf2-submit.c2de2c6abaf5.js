(function () {
  ...
  var ieltsWritingMatch = /^IELTS-WRITING-W05$/.exec(requestedCode);
  ...
  var matchedUnit = correctionMatch
    ...
    : (academicMatch ? Number(academicMatch[1]) : (grammarMatch ? grammarMatch[1] : (ieltsWritingMatch ? 5 : (ieltsReadingMatch ? 1 : (codeMatch ? Number(codeMatch[2]) : 0)))));
    ...
    : (submissionKind === "academic"
      ...
      : (submissionKind === "grammar"
        ...
        : (submissionKind === "ieltsWriting"
          ? Object.freeze({ short: "vở chép", eyebrow: "NỘP VỞ CHÉP", title: "Buổi 05 · Nộp vở chép", file: "vo-chep" })

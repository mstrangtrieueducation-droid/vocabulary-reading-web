(function () {
  ...
  var submissionKind = correctionMatch ? "correction" : (academicMatch ? "academic" : (grammarMatch ? "grammar" : (ieltsReadingMatch ? "ieltsReading" : "vocabulary")));
  ...
  var matchedUnit = correctionMatch
    ...
    : (academicMatch ? Number(academicMatch[1]) : (grammarMatch ? grammarMatch[1] : (ieltsReadingMatch ? 1 : (codeMatch ? Number(codeMatch[2]) : 0))));
